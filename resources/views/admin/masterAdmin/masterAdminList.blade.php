...
@section('body')
    @include('admin.masterAdmin.masterAdminCreate')
                                            ...
                                            <div class="btn-group dropleft">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item btn-modal-general"
                                                       data-route="{{ route('admin.masterAdminEdit', ['admin_id' => $row->admin_id]) }}"
                                                       href="#">
                                                        Edit
                                                    </a>
                                                    <a class="dropdown-item btn-confirm-general"
                                                       href="#"
                                                       data-route="{{ route('admin.masterAdminDelete', ['admin_id' => $row->admin_id]) }}"
