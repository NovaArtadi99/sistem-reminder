<form action="{{ route('testimoniDataUpdate', ['testimoni_id' => $row->testimoni_id]) }}" method="post"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="testi_name" class="form-control" value="{{ $row->testi_name }}">
                    </div>
                    <div class="form-group">
                        <label>Description</label>
                        <textarea name="testi_description" class="form-control tinymce">{{ $row->testi_description }}</textarea>
                    </div>
                    <div class="form-group">
                        <label>Active ?</label>
                        <br />
